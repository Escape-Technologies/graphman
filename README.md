...
2. Run:
   `deno run https://deno.land/x/graphman@v1.1.1/src/lib.ts <graphql endpoint url>`
...
1. [Install deno](https://deno.land/#installation)
2. Run:
   `deno install -r -f --allow-net --allow-write -n graphman https://deno.land/x/graphman@v1.1.1/src/lib.ts`
...
- Rick&Morty API:
  `deno run https://deno.land/x/graphman@v1.1.1/src/lib.ts https://rickandmortyapi.com/graphql`
